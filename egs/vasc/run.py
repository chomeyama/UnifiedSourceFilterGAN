...
# This code is modified from https://github.com/bigpon/QPPWG.
...
LIBRARY_DIR = "/usr/local/cuda-11.0/lib64"
...
if __name__ == "__main__":
    ...
    # path setting
    network        = "usfgan"
    entry_fe       = "usfgan-preprocess"
    entry_stats    = "usfgan-compute-statistics"
    entry_train    = "usfgan-train"
    entry_decode   = "usfgan-decode"
    train_version  = "vasc_train_22kHz"  # training
    valid_version  = "vasc_valid_22kHz"  # validation
    eval_version   = "vasc_eval_22kHz"   # evaluation    
    ...
    config        = "conf/vasc.%s.yaml" % (config_version)
