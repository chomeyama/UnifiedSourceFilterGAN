...
"""Train Unified Source-Filter GAN."""
...
import usfgan.optimizers

from usfgan.datasets import AudioFeatDataset
from usfgan.losses import MultiResolutionSTFTLoss
from usfgan.losses import SourceLoss
from usfgan.utils import read_hdf5
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description="Train Unified Source-Filter GAN (See detail in usfgan/bin/train.py).")
    ...
    config["version"] = usfgan.__version__  # add version info
    ...
    criterion = {
        ...
        "source": SourceLoss(
            **config["source_loss_params"]).to(device),
    }
